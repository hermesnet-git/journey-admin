...
/**
 * Checks for active (PUBLISHED) journey publications, used to guard product/journey deactivation
 * (REQ-01.04.004/005, REQ-02.01.006). Publications are introduced in EP-06; until then, no
