...
/** Os 4 alvos de renderização do catálogo (seção 4) — identificadores estáveis usados como chave
...
public final class RenderTarget {
    ...
    public static final List<String> ALL = List.of(REACT_WEB, REACT_MOBILE, FLUTTER_WEB, FLUTTER_MOBILE);
