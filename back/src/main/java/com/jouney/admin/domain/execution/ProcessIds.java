...
/** Mesma convenção usada em ms-transform-publication, ms-espec-registry e ms-journey (sem módulo
 * compartilhado entre os serviços): chave de definição de processo = "Journey_" + UUID sem
 * hifens. */
