 ...
 * sempre existe pra um passo concluído); {@code endTime}, idem. {@code taskId} e {@code formAnswers}
 * só existem pra USER_TASK (id real da tarefa no motor, via {@code /history/task}, e as respostas
