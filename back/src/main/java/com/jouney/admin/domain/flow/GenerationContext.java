...
public record GenerationContext(String prompt, String journeyName, String journeyDescription, String productName,
                                 ...
                                 List<FormSummary> forms, List<FlowNode> currentFlowNodes,
                                 List<FlowConnection> currentFlowConnections) {

    // fieldNames já exclui campos TEXT/FILE_UPLOAD/SECTION, mesmo filtro que o UpdateFlow aplica ao
    // resolver quais campos de formulário viram referências {{variavel}} (ver
    // UpdateFlow.formFieldNamesByFormId).
