...
'[
  ...
  {"id":"Node_d_st","type":"SERVICE_TASK","name":"Consultar operadora de origem","description":"Consulta prazo estimado de portabilidade","positionX":560,"positionY":300,"formId":null,"connectorConfig":{"connectorType":"REST","config":{"method":"GET","url":"http://localhost:8084/v1/portabilidade/consulta","headers":{"Content-Type":"application/json"},"params":null,"body":null,"outputMapping":[{"name":"prazoDias","jsonPath":"$.prazoEstimadoDias","type":"number"}]},"credentialRef":"cred-telecom-core-api"}},
...
'[
  ...
  {"id":"Node_e_st1","type":"SERVICE_TASK","name":"Consultar score de retenção","description":"Calcula a propensão de retenção do cliente","positionX":560,"positionY":300,"formId":null,"connectorConfig":{"connectorType":"REST","config":{"method":"GET","url":"http://localhost:8084/v1/retencao/score","headers":{"Content-Type":"application/json"},"params":null,"body":null,"outputMapping":[{"name":"scoreRetencao","jsonPath":"$.score","type":"number"}]},"credentialRef":"cred-telecom-core-api"}},
...
'[
  ...
  {"id":"Node_g_st1","type":"SERVICE_TASK","name":"Verificar elegibilidade de upgrade","description":"Consulta se o cliente pode migrar de plano","positionX":560,"positionY":300,"formId":null,"connectorConfig":{"connectorType":"REST","config":{"method":"GET","url":"http://localhost:8084/v1/planos/elegibilidade-upgrade","headers":{"Content-Type":"application/json"},"params":null,"body":null,"outputMapping":[{"name":"elegivel","jsonPath":"$.elegivel","type":"boolean"}]},"credentialRef":"cred-telecom-core-api"}},
