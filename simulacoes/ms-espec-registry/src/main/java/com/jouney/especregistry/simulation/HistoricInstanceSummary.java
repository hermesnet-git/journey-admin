 ...
 * versão de negócio (versionTag) resolvida em {@link InstanceHistoryResponse}. {@code channel} vem de
 * uma segunda chamada em lote (ver {@link com.jouney.especregistry.camunda.CamundaClient#getChannelsForInstances})
 * e é {@code null} pra instâncias sem a variável de processo (deploy anterior ao conceito multicanal). */
